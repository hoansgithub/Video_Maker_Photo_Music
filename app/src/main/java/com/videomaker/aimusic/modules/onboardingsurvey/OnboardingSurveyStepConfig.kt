...
data class OnboardingSurveyStepConfig(
    ...
    val primaryPlacement: String,
    val altPlacement: String,
...
val FEATURE_CONFIG = OnboardingSurveyStepConfig(
    ...
    primaryPlacement = AdPlacement.NATIVE_ONBOARDING_SELECT,
    altPlacement = AdPlacement.NATIVE_ONBOARDING_SELECT_ALT,
...
val PLATFORM_CONFIG = OnboardingSurveyStepConfig(
    ...
    primaryPlacement = AdPlacement.NATIVE_ONBOARDING_SOCIAL,
    altPlacement = AdPlacement.NATIVE_ONBOARDING_SOCIAL_ALT,
