package com.aimusic.videoeditor.data.local.database

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import com.aimusic.videoeditor.data.local.database.dao.AssetDao
import com.aimusic.videoeditor.data.local.database.dao.ProjectDao
import com.aimusic.videoeditor.data.local.database.entity.AssetEntity
